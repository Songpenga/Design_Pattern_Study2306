...
public class MainEntry {
	public static void main(String[] args) {
		...
		String footer = "2023.06.15 GIS Developer";
		
		Article article = new Article(title, content, footer);
		
		System.out.println("[CASE-1]");
		DisplayAriticleTemplate style1 = new SimpleDisplayArticle(article);
		style1.display();
		
		System.out.println("=================================");
		
		System.out.println("[CASE-2]");
		DisplayAriticleTemplate style2 = new CaptionDisplayArticle(article);
		style2.display();
